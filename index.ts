...
const server: Plugin = (async (ctx) => {
  ...
  const tools: Record<string, ToolDefinition> = {
    paseo_status: createStatusTool(state, logger),
    ...
    paseo_terminal_list: createTerminalListTool(client, logger),
    paseo_terminal_create: createTerminalCreateTool(state, client, logger),
    paseo_terminal_capture: createTerminalCaptureTool(client, logger),
    paseo_terminal_send_input: createTerminalSendInputTool(client, logger),
    paseo_terminal_send_lines: createTerminalSendLinesTool(client, logger),
